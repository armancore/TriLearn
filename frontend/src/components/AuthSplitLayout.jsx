  ...
  return (
    <div className="min-h-screen bg-slate-100">
      <div className={`min-h-screen ${hideAside ? '' : 'grid lg:grid-cols-[minmax(0,0.92fr)_minmax(0,1.08fr)]'}`}>
        ...
        <main className={`flex min-h-screen bg-white px-4 py-10 sm:px-8 lg:px-12 ${alignmentClassName} ${mainClassName}`}>
          <div className={`mx-auto w-full ${contentWidthClassName}`}>
            <div className={`ui-card overflow-hidden rounded-[1.75rem] border-slate-200/80 bg-white shadow-[0_28px_70px_-36px_rgba(15,23,42,0.45)] ${cardClassName}`}>
